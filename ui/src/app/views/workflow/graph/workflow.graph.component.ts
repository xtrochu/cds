...
import { CytoscapeEvent, CytoscapeHtmlContainer } from 'app/model/cytoscape.model';
...
export class WorkflowGraphComponent implements AfterViewInit {
    ...
    initGraph() {
        ...
        var style = <Stylesheet[]>[ // the stylesheet for the graph
            {
                selector: 'node',
                style: {
        ...
        var elements = <ElementsDefinition>{
            nodes: [],
            edges: []
        };
